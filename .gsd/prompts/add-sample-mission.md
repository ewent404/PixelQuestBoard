...
Active change: Add sample mission
...
- openspec/changes/add-sample-mission/proposal.md
- openspec/changes/add-sample-mission/tasks.md
- .gsd/reasoning/add-sample-mission.md
